...
public class AddSongDialog extends AppCompatDialogFragment{
    SongDialogInterface songDialogInterface;
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = layoutInflater.inflate(R.layout.add_song_popup, null);
        ...
        builder.setView(view).setPositiveButton("Save", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(getContext(), "Adding New Song", Toast.LENGTH_SHORT).show();
                ...
                songDialogInterface.apply(sname, aname, fname);
            }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        songDialogInterface = (SongDialogInterface) context;
    }

    public interface SongDialogInterface{
        void apply (String sname, String aname, String fname);
    }
}
